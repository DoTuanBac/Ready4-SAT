...
export default function CircularProgress({percent, radius, bgRingWidth, progressRingWidth, ringColor, ringBgColor,
  textFontSize, textFontWeight, clockwise, bgColor, startDegrees, children}){
  const commonStyles = {
    width: radius * 2,
    height: radius * 2,
    borderRadius: radius
